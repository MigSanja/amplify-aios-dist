...
Module, die echte Arbeit übernehmen. Läuft lokal auf deinem Mac, deine Daten bleiben bei dir.
...
Der Installer prüft die Voraussetzungen, holt das AIOS nach `~/AIOS` und sagt dir den nächsten Schritt.
Danach öffnest du den Ordner `~/AIOS` in **Claude Code** und tippst:

```
/aios-setup
```

Claude Code führt dich dann Schritt für Schritt durch alles. Jeder Schritt ist überspringbar,
du kannst alles später nachholen.
